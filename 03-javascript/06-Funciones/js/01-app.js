// Las funciónes en cualquier lenguaje son una serie desubrutinas, procedimientos o instrucciones que realizan una acción. Las funciónes permiten tener un código más ordenado, fácil de mantener y reutilizable.. Puedes tener una función que valide un formulario y utilizarla en todos tus formularios, puedes tener también una función que envie datos al servidor y reutilizarla múltiples veces...

// Existen 3 formas de crear funciónes en JavaScript

// Declaración de Función -> la expresión de la función utiliza la palabra reservada function seguida de un nombre y un parentesis, en este parentesis se colocan los argumentos, si los necesita, finalmente el cuerpo o predicado de la función se define por unas llaves...
...
sumar(a, b); // se manda llamar por su nombre seguido del parentesis() con parámetros si los necesita
...
/// A visualizar al ver métodos y funciones para Objetos tipo Array
